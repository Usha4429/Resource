		...
		$.ajax({
            ...
            success: function(list) {
    			$.each(list, function(index,data) {
    				...
    				var something= '<td><input align="center" id="editButton" type="submit" name="Edit" onclick="return aerogear.Edit()" data-icon="Edit" value="Edit" /></td>';
    					row+= something;
    				row += "</tr>";
        ...
        $.ajax({
        	...
        	error: function(error) {
                 if (error.status == 412) {
                    ...
                    $('#formMsgs').append($('<span class="invalid">Please enter valid details.</span>'));
                 }
        	}
        });
